...
void SPIDevice::printVars() {

	cout << "SPI_IOC_WR_MAX_SPEED_HZ: " << SPI_IOC_WR_MAX_SPEED_HZ << endl;
	cout << "SPI_IOC_RD_MAX_SPEED_HZ: " << SPI_IOC_WR_MAX_SPEED_HZ << endl;
	cout << "SPI_IOC_WR_MODE: " << SPI_IOC_WR_MODE << endl;
	cout << "SPI_IOC_RD_MODE: " << SPI_IOC_RD_MODE << endl;
	cout << "SPI_IOC_WR_BITS_PER_WORD: " << SPI_IOC_WR_BITS_PER_WORD << endl;
	cout << "SPI_IOC_RD_BITS_PER_WORD: " << SPI_IOC_RD_BITS_PER_WORD << endl;
        cout << "sizeof spi_ioc_transfer: " << sizeof (struct spi_ioc_transfer) << endl;
        cout << "_IOC_SIZEBITS: " << _IOC_SIZEBITS << endl;
        cout << "SPI_MSGSIZE(N):" << SPI_MSGSIZE(2) << endl;
        cout << char[SPI_MSGSIZE(2)] << endl;
        cout << "_IOC(_IOC_WRITE,(107),(0),(_IOC_TYPECHECK(32))): " << _IOC(_IOC_WRITE,(107),(0),(_IOC_TYPECHECK(char[SPI_MSGSIZE(1)])))
 << endl;
	cout << "_IOC(_IOC_WRITE,(107),(0),(_IOC_TYPECHECK(64))): " << _IOC(_IOC_WRITE,(107),(0),(_IOC_TYPECHECK(char[SPI_MSGSIZE(2)])))
 << endl;

        cout << "_IOW(SPI_IOC_MAGIC, 0, char[SPI_MSGSIZE(2)]): " << _IOW(SPI_IOC_MAGIC, 0, char[SPI_MSGSIZE(2)]) << endl;
        cout << "SPI_IOC_MAGIC: " << SPI_IOC_MAGIC << endl;
        cout << "sizeof char[SPI_MSGSIZE(1)]: " << sizeof(char[SPI_MSGSIZE(1)]) << endl;
        cout << "SPI_IOC_MESSAGE(1): " << SPI_IOC_MESSAGE(1) << endl;
        cout << "SPI_IOC_MESSAGE(2): " << SPI_IOC_MESSAGE(2) << endl;
}
